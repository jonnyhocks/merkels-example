...
public class DES {
	 ...
	 * @param secretKey The key to encrypt/decrypt the message.
	 *
	 * @return encryptedText The encrypted message.
	 */
	 ...
	 * @param secretKey The key to decrypt the message.
	 *
	 * @return decryptedText The decrypted plaintext message.
	 */
	...
	/**
	 * Generates a random key used to encrypt/decrypt a message.
	 * @return secretyKey The secret key.
	 */
	...
	/**
	 * Generate a secret key using a MAC and message digest.
	 * @param password The password to be used for the key.
